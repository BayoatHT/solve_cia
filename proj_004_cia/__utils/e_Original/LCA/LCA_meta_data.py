# ────────────────────────────────────────────────────────────────────────────────────────────
# Enhanced Country Meta Data - LCA
# ────────────────────────────────────────────────────────────────────────────────────────────
...
# ENHANCED COUNTRY META DATA FOR LCA
# ────────────────────────────────────────────────────────────────────────────────────────────
# This dictionary contains comprehensive enhanced metadata for LCA.
# Includes base country information plus recent indicator data for all topics.
# 
# Usage:
#   from impact_titan.impact_3_data.h_saved_world_system.countries.a_impact_country_meta.Original.LCA.LCA_meta_data import LCA_meta_data
#   
#   country_name = LCA_meta_data['name']
#   gdp_data = LCA_meta_data.get('wb_gdp_capita', {})
#   population = LCA_meta_data.get('wb_total_pop', {})
# ────────────────────────────────────────────────────────────────────────────────────────────
...
LCA_meta_data = {
    ...
    "gdp": 2065027555.55556,
    "gdpPerCapita": 11481.496719925,
    "gdpPpp": 3193534629.69747,
    "gdpPppPerCapita": 17755.9651817692,
    "ciCountryName": "saint lucia",
    "ciIso2Code": "LC",
    "callingCodes": [
        "1758"
    ],
    ...
    "ciLatitude": 13.88333333,
    "ciLongitude": -60.96666666,
    "ciCapital": "Castries",
    "capitalLatitude": 13.952589,
    "capitalLongitude": -60.987824,
    "ciBorders": [],
    "provinces": [
        "Anse-la-Raye",
        "Castries",
    ...
    "_retrieval_metadata": {
        ...
        "retrieval_timestamp": "2025-08-08T18:20:30.860323",
        "topic_update_mode": "all",
        "topics_requested": 0,
        "topics_updated": 0,
        "topics_failed": 0,
        ...
        "is_country": True,
        "is_region": False,
        "enhancement_timestamp": "2025-08-08T18:20:30.865324"
    }
}
...
def get_country_name():
    ...
    return LCA_meta_data.get('name', 'Unknown')
...
def get_topic_data(topic_key):
    ...
    return LCA_meta_data.get(topic_key, {})

def get_all_topics():
    """Get a list of all available topic keys in this dataset."""
    return [key for key in LCA_meta_data.keys() if key.startswith(('wb_', 'custom_', 'country_', 'region_'))]
...
def validate_data_completeness():
    ...
    total_fields = len(LCA_meta_data)
    topics = get_all_topics()
    retrieval_meta = LCA_meta_data.get('_retrieval_metadata', {})
...
if __name__ == '__main__':
    print("═" * 80)
    print(f"ENHANCED COUNTRY META DATA - LCA - VALIDATION")
    print("═" * 80)
