# ────────────────────────────────────────────────────────────────────────────────────────────
# Enhanced Country Meta Data - DMA
# ────────────────────────────────────────────────────────────────────────────────────────────
...
# ENHANCED COUNTRY META DATA FOR DMA
# ────────────────────────────────────────────────────────────────────────────────────────────
# This dictionary contains comprehensive enhanced metadata for DMA.
# Includes base country information plus recent indicator data for all topics.
# 
# Usage:
#   from impact_titan.impact_3_data.h_saved_world_system.countries.a_impact_country_meta.Original.DMA.DMA_meta_data import DMA_meta_data
#   
#   country_name = DMA_meta_data['name']
#   gdp_data = DMA_meta_data.get('wb_gdp_capita', {})
#   population = DMA_meta_data.get('wb_total_pop', {})
# ────────────────────────────────────────────────────────────────────────────────────────────
...
DMA_meta_data = {
    ...
    "gdp": 612048148.148148,
    "gdpPerCapita": 8414.53659276775,
    "gdpPpp": 987257335.533635,
    "gdpPppPerCapita": 13572.9729784516,
    "ciCountryName": "dominica",
    "ciIso2Code": "DM",
    "callingCodes": [
        "1767"
    ],
    ...
    "ciLatitude": 15.41666666,
    "ciLongitude": -61.33333333,
    "ciCapital": "Roseau",
    "capitalLatitude": 48.771037,
    "capitalLongitude": -95.769788,
    "ciBorders": [],
    "provinces": [
        "Saint Andrew",
        "Saint David",
    ...
    "_retrieval_metadata": {
        ...
        "retrieval_timestamp": "2025-08-08T18:20:29.176681",
        "topic_update_mode": "all",
        "topics_requested": 0,
        "topics_updated": 0,
        "topics_failed": 0,
        ...
        "is_country": True,
        "is_region": False,
        "enhancement_timestamp": "2025-08-08T18:20:29.180680"
    }
}
...
def get_country_name():
    ...
    return DMA_meta_data.get('name', 'Unknown')
...
def get_topic_data(topic_key):
    ...
    return DMA_meta_data.get(topic_key, {})

def get_all_topics():
    """Get a list of all available topic keys in this dataset."""
    return [key for key in DMA_meta_data.keys() if key.startswith(('wb_', 'custom_', 'country_', 'region_'))]
...
def validate_data_completeness():
    ...
    total_fields = len(DMA_meta_data)
    topics = get_all_topics()
    retrieval_meta = DMA_meta_data.get('_retrieval_metadata', {})
...
if __name__ == '__main__':
    print("═" * 80)
    print(f"ENHANCED COUNTRY META DATA - DMA - VALIDATION")
    print("═" * 80)
