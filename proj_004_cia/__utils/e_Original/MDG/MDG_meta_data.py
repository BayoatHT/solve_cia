# ────────────────────────────────────────────────────────────────────────────────────────────
# Enhanced Country Meta Data - MDG
# ────────────────────────────────────────────────────────────────────────────────────────────
...
# ENHANCED COUNTRY META DATA FOR MDG
# ────────────────────────────────────────────────────────────────────────────────────────────
# This dictionary contains comprehensive enhanced metadata for MDG.
# Includes base country information plus recent indicator data for all topics.
# 
# Usage:
#   from impact_titan.impact_3_data.h_saved_world_system.countries.a_impact_country_meta.Original.MDG.MDG_meta_data import MDG_meta_data
#   
#   country_name = MDG_meta_data['name']
#   gdp_data = MDG_meta_data.get('wb_gdp_capita', {})
#   population = MDG_meta_data.get('wb_total_pop', {})
# ────────────────────────────────────────────────────────────────────────────────────────────
...
MDG_meta_data = {
    ...
    "gdp": 14954967604.4073,
    "gdpPerCapita": 505.035527643123,
    "gdpPpp": 52533215226.0974,
    "gdpPppPerCapita": 1774.06870896083,
    "ciCountryName": "madagascar",
    "ciIso2Code": "MG",
    "callingCodes": [
        "261"
    ],
    ...
    "ciLatitude": -20,
    "ciLongitude": 47,
    "ciCapital": "Antananarivo",
    "capitalLatitude": -18.910012,
    "capitalLongitude": 47.525581,
    "ciBorders": [],
    "provinces": [
        "Antananarivo",
        "Antsiranana",
    ...
    "_retrieval_metadata": {
        ...
        "retrieval_timestamp": "2025-08-08T18:20:31.163160",
        "topic_update_mode": "all",
        "topics_requested": 0,
        "topics_updated": 0,
        "topics_failed": 0,
        ...
        "is_country": True,
        "is_region": False,
        "enhancement_timestamp": "2025-08-08T18:20:31.167166"
    }
}
...
def get_country_name():
    ...
    return MDG_meta_data.get('name', 'Unknown')
...
def get_topic_data(topic_key):
    ...
    return MDG_meta_data.get(topic_key, {})

def get_all_topics():
    """Get a list of all available topic keys in this dataset."""
    return [key for key in MDG_meta_data.keys() if key.startswith(('wb_', 'custom_', 'country_', 'region_'))]
...
def validate_data_completeness():
    ...
    total_fields = len(MDG_meta_data)
    topics = get_all_topics()
    retrieval_meta = MDG_meta_data.get('_retrieval_metadata', {})
...
if __name__ == '__main__':
    print("═" * 80)
    print(f"ENHANCED COUNTRY META DATA - MDG - VALIDATION")
    print("═" * 80)
