# ────────────────────────────────────────────────────────────────────────────────────────────
# Enhanced Country Meta Data - PAN
# ────────────────────────────────────────────────────────────────────────────────────────────
...
# ENHANCED COUNTRY META DATA FOR PAN
# ────────────────────────────────────────────────────────────────────────────────────────────
# This dictionary contains comprehensive enhanced metadata for PAN.
# Includes base country information plus recent indicator data for all topics.
# 
# Usage:
#   from impact_titan.impact_3_data.h_saved_world_system.countries.a_impact_country_meta.Original.PAN.PAN_meta_data import PAN_meta_data
#   
#   country_name = PAN_meta_data['name']
#   gdp_data = PAN_meta_data.get('wb_gdp_capita', {})
#   population = PAN_meta_data.get('wb_total_pop', {})
# ────────────────────────────────────────────────────────────────────────────────────────────
...
PAN_meta_data = {
    ...
    "latitude": 8.99427,
    "countryName": "Panama",
    "officialStateName": "The Republic of PanamÃ¡",
    "sovereignty": "UN member state",
    "alpha2Code": "PA",
    "alpha3Code": "PAN",
    "numericCode": "591",
    "subdivisionCode": "ISO 3166-2:PA",
    "ccTLD": ".pa",
    "internetCode": ".pa",
    "population": 4408581,
    "surfaceArea": 75320,
    ...
    "gdp": 76522511780.6222,
    "gdpPerCapita": 17357.6286293985,
    "gdpPpp": 173167630551.442,
    "gdpPppPerCapita": 39279.6753765989,
    "ciCountryName": "panama",
    "ciIso2Code": "PA",
    "callingCodes": [
        "507"
    ],
    ...
    "ciLatitude": 9,
    "ciLongitude": -80,
    "ciCapital": "Panama City",
    "capitalLatitude": 8.971449,
    "capitalLongitude": -79.53418,
    "ciBorders": [
        "COL",
        "CRI"
    ],
    ...
    "_retrieval_metadata": {
        ...
        "retrieval_timestamp": "2025-08-08T18:20:31.875689",
        "topic_update_mode": "all",
        "topics_requested": 0,
        "topics_updated": 0,
        "topics_failed": 0,
        ...
        "is_country": True,
        "is_region": False,
        "enhancement_timestamp": "2025-08-08T18:20:31.878686"
    }
}
...
def get_country_name():
    ...
    return PAN_meta_data.get('name', 'Unknown')
...
def get_topic_data(topic_key):
    ...
    return PAN_meta_data.get(topic_key, {})

def get_all_topics():
    """Get a list of all available topic keys in this dataset."""
    return [key for key in PAN_meta_data.keys() if key.startswith(('wb_', 'custom_', 'country_', 'region_'))]
...
def validate_data_completeness():
    ...
    total_fields = len(PAN_meta_data)
    topics = get_all_topics()
    retrieval_meta = PAN_meta_data.get('_retrieval_metadata', {})
...
if __name__ == '__main__':
    print("═" * 80)
    print(f"ENHANCED COUNTRY META DATA - PAN - VALIDATION")
    print("═" * 80)
