# ────────────────────────────────────────────────────────────────────────────────────────────
# Enhanced Country Meta Data - ETH
# ────────────────────────────────────────────────────────────────────────────────────────────
...
# ENHANCED COUNTRY META DATA FOR ETH
# ────────────────────────────────────────────────────────────────────────────────────────────
# This dictionary contains comprehensive enhanced metadata for ETH.
# Includes base country information plus recent indicator data for all topics.
# 
# Usage:
#   from impact_titan.impact_3_data.h_saved_world_system.countries.a_impact_country_meta.Original.ETH.ETH_meta_data import ETH_meta_data
#   
#   country_name = ETH_meta_data['name']
#   gdp_data = ETH_meta_data.get('wb_gdp_capita', {})
#   population = ETH_meta_data.get('wb_total_pop', {})
# ────────────────────────────────────────────────────────────────────────────────────────────
...
ETH_meta_data = {
    ...
    "alpha3Code": "ETH",
    "numericCode": "231",
    "subdivisionCode": "ISO 3166-2:ET",
    "ccTLD": ".et",
    "internetCode": ".et",
    "population": 123379924,
    "surfaceArea": 1136239.544,
    "landArea": 1128571.265,
    "neighbors": [
        "ERI",
        "DJI",
        "SOM",
    ...
    "gdpPerCapita": 1027.58591828225,
    "gdpPpp": 346892741942.674,
    "gdpPppPerCapita": 2811.58174439039,
    "ciCountryName": "ethiopia",
    "ciIso2Code": "ET",
    "callingCodes": [
        "251"
    ],
    ...
    "ciLatitude": 8,
    "ciLongitude": 38,
    "ciCapital": "Addis Ababa",
    "capitalLatitude": 9.010793,
    "capitalLongitude": 38.761252,
    "ciBorders": [
        "DJI",
        "ERI",
        "KEN",
    ...
    "_retrieval_metadata": {
        ...
        "retrieval_timestamp": "2025-08-08T18:20:29.420680",
        "topic_update_mode": "all",
        "topics_requested": 0,
        "topics_updated": 0,
        "topics_failed": 0,
        ...
        "is_country": True,
        "is_region": False,
        "enhancement_timestamp": "2025-08-08T18:20:29.426682"
    }
}
...
def get_country_name():
    ...
    return ETH_meta_data.get('name', 'Unknown')
...
def get_topic_data(topic_key):
    ...
    return ETH_meta_data.get(topic_key, {})

def get_all_topics():
    """Get a list of all available topic keys in this dataset."""
    return [key for key in ETH_meta_data.keys() if key.startswith(('wb_', 'custom_', 'country_', 'region_'))]
...
def validate_data_completeness():
    ...
    total_fields = len(ETH_meta_data)
    topics = get_all_topics()
    retrieval_meta = ETH_meta_data.get('_retrieval_metadata', {})
...
if __name__ == '__main__':
    print("═" * 80)
    print(f"ENHANCED COUNTRY META DATA - ETH - VALIDATION")
    print("═" * 80)
