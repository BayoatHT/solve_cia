...
def parse_electricity_from_fossil(iso3Code: str, return_original: bool = False)-> dict:
        ...
        if 'text' in pass_data:
            ...
            if text and isinstance(text, str):
                ...
                if parsed['value'] is not None:
                    result['elec_fossil_value'] = parsed['value']
                if parsed['unit']:
                    result['elec_fossil_unit'] = parsed['unit']
                if parsed['year']:
                    result['elec_fossil_year'] = parsed['year']
