"""
Helper function to parse communications values into structured components.
...
def parse_comms_value(text: str, return_original: bool = False)-> Dict[str, Any]:
    """
    Parse communications value text into structured components.
    ...
    Examples:
        >>> parse_comms_value("4.941 billion metric tonnes of CO2 (2022 est.)")
        {
            'value': 4941000000.0,
            'raw_value': 4.941,
            'magnitude': 'billion',
    ...
    try:
        ...
        logging.error(f"Error parsing communications value '{text}': {e}")
...
if __name__ == "__main__":
    ...
    print("Testing parse_comms_value:\n")
    for test in test_cases:
        result = parse_comms_value(test)
        print(f"Input: '{test}'")
